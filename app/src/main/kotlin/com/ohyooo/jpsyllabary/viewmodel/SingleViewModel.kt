package com.ohyooo.jpsyllabary.viewmodel
...
object SingleViewModel {
    private var tvQueue: Queue<Int> = LinkedList()
    ...
    private fun getType(name: Int) = when (name) {
        in 0..44 -> R.string.katakanaWithVoiceless
        in 45..89 -> R.string.hiraganaWithVoiceless
        in 90..109 -> R.string.katakanaWithVoicedSound
        in 110..129 -> R.string.hiraganaWithVoicedSound
        in 130..134 -> R.string.hiraganaWithSemiVoiced
        in 135..139 -> R.string.katakanaWithSemivoiced
        else -> R.string.empty
    }
