...
import com.ohyooo.jpsyllabary.viewmodel.SingleViewModel
...
fun Single(onMenuClick: () -> Unit = {}) {
    ...
    Column(
        ...
        var type by rememberSaveable { mutableStateOf(R.string.katakanaWithVoiceless) }
...
fun ClickButton(modifier: Modifier, onClick: () -> Unit) {
    Image(
        painter = painterResource(R.mipmap.round),
